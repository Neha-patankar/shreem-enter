...
//                         }}
//                       ></i>
//                       <p>shreementerprises@gmail.com</p>
//                     </a>
//                   </li>
...
//             <li className="contact-detailss flex-wrap">
//             <a
//               href="mailto:info@email.com"
//               className="d-flex fs-6 text-decoration-none  "
//             >
           
//               <i
//                 className="fa-solid fa-envelope pe-2 pt-1"
//                 style={{
//                   color: "#ff4328",
//                   textDecoration: "none",
//                 }}
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3 mb-4 footer-col">
            <h5 className="footer-heading">Shreem Enterprises</h5>
            <p>
              Shreem Enterprises is dedicated
              <br /> to providing top-notch services
              <br /> to our clients. Our commitment
              <br /> to excellence has established us
              <br /> as a trusted name in the industry.
            </p>
          </div>
          <div className="col-md-2 mb-4 footer-col2">
            <h5>Services</h5>
        ...
        <div className="row align-items-center justify-content-lg-between bbox pb-5">
          <div className="col-md-12 footer-bottom-boxed ms-3 d-flex">
            ...
            <div className="ast-footer-site-title">
              <a href="/terms-and-conditions" className="linkss pe-5 me-5">
                Terms & Conditions
              </a>
            </div>
          </div>
