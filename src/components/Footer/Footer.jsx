      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mt-2">
                <a href="#requestservices" className="text-dark text-decoration-none">Request a Service</a>
              </li>
              <li className="mt-2">
                <a href="#contact" className="text-dark text-decoration-none">Contact</a>
              </li>
          ...
          <div className="col-md-3 mb-4">
            ...
            <div className="d-flex social-media">
              <ul className="list-unstyled d-flex gap-3">
                <li>
                  <a href="#"><i className="fa-brands fa-whatsapp fs-3 whatshop"></i></a>
                </li>
                <li>
                  <i className="fa-brands fa-instagram text-danger fs-3 instra"></i>
                </li>
                <li>
                  <i className="fa-brands fa-facebook text-primary fs-3"></i>
                </li>
                <li>
                  <i className="fa-brands fa-linkedin text-primary fs-3"></i>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="row align-items-center justify-content-lg-between bbox">
          <div className="col-md-12 footer-bottom-boxed">
            <p className="copyright_text mb-0 pl-4 sub-title-footer">&copy; 2024 Shreem Enterprises. All rights reserved.</p>
            <div><a href="/terms-and-conditions" className="linkss">Terms & Conditions</a></div>
            <div className="ast-footer-site-title">
              Made by <span className="footer-site-title">SSS Technologies</span>
            </div>
          </div>
        </div>
      </div>
